...
local Library = {
    ...
    ImageManager = {
        GetAsset = function() warn("ImageManager: Has Not Neen Loaded Yet!")end,
        AddAsset = function() warn("ImageManager: Has Not Neen Loaded Yet!") end,
        DownloadAsset = function() warn("ImageManager: Has Not Neen Loaded Yet!") end,
    }
}
...
if RunService:IsStudio() then
    if UserInputService.TouchEnabled and not UserInputService.MouseEnabled then
        ...
        Library.OriginalMinSize = Vector2.new(420, 360)
    else
        Library.IsMobile = false
        Library.OriginalMinSize = Vector2.new(420, 480)
    end
else
    pcall(function()
    ...
    Library.OriginalMinSize = Library.IsMobile and Vector2.new(420, 360) or Vector2.new(420, 480)
end
